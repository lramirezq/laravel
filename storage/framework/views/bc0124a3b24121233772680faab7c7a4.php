<section>
    <header>
        <h2 class="text-lg font-medium text-gray-900 dark:text-white">
            <?php echo e(trans('tomato-admin::global.profile.password-title')); ?>

        </h2>

        <p class="mt-1 text-sm text-gray-600 dark:text-gray-300">
            <?php echo e(trans('tomato-admin::global.profile.password-description')); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'mt-6 space-y-6','method' => 'put','action' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('user-password.update')),'stay' => true]); ?>
...
<?php $component = ProtoneMedia\Splade\Components\Form\Input::resolve(['name' => 'current_password','type' => 'password','label' => trans('tomato-admin::global.profile.password-current')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
        <?php if (isset($component)) { $__componentOriginal690b64017277cbdd89bc2d788db21f28 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal690b64017277cbdd89bc2d788db21f28 = $attributes; } ?>
<?php $component = ProtoneMedia\Splade\Components\Form\Input::resolve(['name' => 'password','type' => 'password','label' => trans('tomato-admin::global.profile.password-new')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('splade-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(ProtoneMedia\Splade\Components\Form\Input::class))->getConstructor()): ?>
...
<?php endif; ?>
        <?php if (isset($component)) { $__componentOriginal690b64017277cbdd89bc2d788db21f28 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal690b64017277cbdd89bc2d788db21f28 = $attributes; } ?>
<?php $component = ProtoneMedia\Splade\Components\Form\Input::resolve(['name' => 'password_confirmation','type' => 'password','label' => trans('tomato-admin::global.profile.password-confirmation')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('splade-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(ProtoneMedia\Splade\Components\Form\Input::class))->getConstructor()): ?>
...
<?php $component = ProtoneMedia\Splade\Components\Form\Submit::resolve(['label' => trans('tomato-admin::global.save')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
            ...
            <p class="text-sm text-gray-600 dark:text-gray-300" v-if="form.recentlySuccessful"><?php echo e(trans('tomato-admin::global.saved')); ?></p>
...
<?php /**PATH /Users/lramirez/laravel/admindoc/vendor/tomatophp/tomato-admin/src/../resources/views/profile/partials/update-password-form.blade.php ENDPATH**/ ?>