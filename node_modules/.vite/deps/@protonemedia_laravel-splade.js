...
var Xs = ci || Gs || Function("return this")();
var de = Xs;
var Ks = de.Symbol;
var Ae = Ks;
var di = Object.prototype;
var Ys = di.hasOwnProperty;
var Qs = di.toString;
var pt = Ae ? Ae.toStringTag : void 0;
function Js(e) {
...
var On = Ae ? Ae.toStringTag : void 0;
function Ce(e) {
...
var sa = fi.hasOwnProperty;
var aa = fi.propertyIsEnumerable;
var oa = $n(function() {
  return arguments;
}()) ? $n : function(e) {
...
var En = hi && typeof module == "object" && module && !module.nodeType && module;
var ca = En && En.exports === hi;
var Tn = ca ? de.Buffer : void 0;
var da = Tn ? Tn.isBuffer : void 0;
var fa = da || ua;
var yr = fa;
...
var ba = "[object Date]";
var wa = "[object Error]";
var Sa = "[object Function]";
var Oa = "[object Map]";
var $a = "[object Number]";
var Ea = "[object Object]";
var Ta = "[object RegExp]";
var xa = "[object Set]";
var _a = "[object String]";
var Ia = "[object WeakMap]";
var Aa = "[object ArrayBuffer]";
var Pa = "[object DataView]";
var qa = "[object Float32Array]";
var Ca = "[object Float64Array]";
var Fa = "[object Int8Array]";
var La = "[object Int16Array]";
var ka = "[object Int32Array]";
var Da = "[object Uint8Array]";
...
var yt = mi && typeof module == "object" && module && !module.nodeType && module;
var Va = yt && yt.exports === mi;
var ur = Va && ci.process;
var Ua = function() {
  try {
...
var xn = Ua;
var _n = xn && xn.isTypedArray;
var Ha = _n ? Na(_n) : ja;
var vi = Ha;
var Wa = Object.prototype;
var za = Wa.hasOwnProperty;
function Ga(e, t) {
...
var no = "[object Function]";
var io = "[object GeneratorFunction]";
var so = "[object Proxy]";
function gi(e) {
  if (!H(e))
    return false;
...
var Oi = ref({});
var $i = (e) => Oi.value[e];
var bo = (e) => Object.keys($i.value[e]).length > 0;
var Ei = ref({});
var wo = (e) => Ei.value[e];
var Ti = ref({});
var So = (e) => Ti.value[e];
...
var Vl = 1 / 0;
var An = Ae ? Ae.prototype : void 0;
var Pn = An ? An.toString : void 0;
function Qt(e) {
  if (typeof e == "string")
    return e;
  if (L(e))
...
var Vi = ((e) => (e[e.Error = 0] = "Error", e[e.Overflow = 1] = "Overflow", e[e.Success = 2] = "Success", e[e.Underflow = 3] = "Underflow", e))(Vi || {});
var Ql = ((e) => (e[e.Previous = -1] = "Previous", e[e.Next = 1] = "Next", e))(Ql || {});
...
var ht = Object.assign(defineComponent({ name: "FocusTrap", props: { as: { type: [Object, String], default: "div" }, initialFocus: { type: Object, default: null }, features: { type: Number, default: 30 }, containers: { type: Object, default: ref(/* @__PURE__ */ new Set()) } }, inheritAttrs: false, setup(e, { attrs: t, slots: r, expose: n }) {
  let i = ref(null);
  n({ el: i, $el: i });
  let s = computed(() => lt(i));
  ...
  return () => {
    let m = {}, d = { ref: i, onKeydown: c, onFocusout: h2 }, { features: p, initialFocus: f, containers: g, ...S } = e;
...
var pu = defineComponent({ name: "PortalGroup", props: { as: { type: [Object, String], default: "template" }, target: { type: Object, default: null } }, setup(e, { attrs: t, slots: r }) {
...
var _p = defineComponent({ name: "Description", props: { as: { type: [Object, String], default: "p" }, id: { type: String, default: () => `headlessui-description-${Xe()}` } }, setup(e, { attrs: t, slots: r }) {
  let n = vu();
...
var je = bu(() => /* @__PURE__ */ new Map(), { PUSH(e, t) {
  var r;
...
var en = defineComponent({ name: "Dialog", inheritAttrs: false, props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, open: { type: [Boolean, String], default: qt }, initialFocus: { type: Object, default: null }, id: { type: String, default: () => `headlessui-dialog-${Xe()}` } }, emits: { close: (e) => true }, setup(e, { emit: t, attrs: r, slots: n, expose: i }) {
  ...
  let o = ref(0), l = Jr(), u = computed(() => e.open === qt && l !== null ? X(l.value, { [Ue.Open]: true, [Ue.Closed]: false }) : e.open), c = ref(/* @__PURE__ */ new Set()), h2 = ref(null), m = ref(null), d = computed(() => lt(h2));
  if (i({ el: h2, $el: h2 }), !(e.open !== qt || l !== null))
  ...
  cu(h2, computed(() => g.value ? f.value : false)), mu({ type: "Dialog", enabled: computed(() => p.value === 0), element: h2, onUpdate: (y, O, $) => {
    if (O === "Dialog")
      return X(y, { [Or.Add]() {
  ...
  function E() {
    var y, O, $;
    return [...Array.from((O = (y = d.value) == null ? void 0 : y.querySelectorAll("html > *, body > *, [data-headlessui-portal]")) != null ? O : []).filter((T) => !(T === document.body || T === document.head || !(T instanceof HTMLElement) || T.contains(le(m)) || w.panelRef.value && T.contains(w.panelRef.value))), ($ = w.panelRef.value) != null ? $ : h2.value];
  }
  return nu(() => E(), (y, O) => {
...
var tn = defineComponent({ name: "DialogPanel", props: { as: { type: [Object, String], default: "div" }, id: { type: String, default: () => `headlessui-dialog-panel-${Xe()}` } }, setup(e, { attrs: t, slots: r, expose: n }) {
...
var ut = defineComponent({ props: { as: { type: [Object, String], default: "div" }, show: { type: [Boolean], default: null }, unmount: { type: [Boolean], default: true }, appear: { type: [Boolean], default: false }, enter: { type: [String], default: "" }, enterFrom: { type: [String], default: "" }, enterTo: { type: [String], default: "" }, entered: { type: [String], default: "" }, leave: { type: [String], default: "" }, leaveFrom: { type: [String], default: "" }, leaveTo: { type: [String], default: "" } }, emits: { beforeEnter: () => true, afterEnter: () => true, beforeLeave: () => true, afterLeave: () => true }, setup(e, { emit: t, attrs: r, slots: n, expose: i }) {
  ...
  i({ el: s, $el: s });
  let { show: l, appear: u } = qu(), { register: c, unregister: h2 } = Cu(), m = { value: true }, d = Xe(), p = { value: false }, f = Ji(() => {
    p.value || (a.value = "hidden", h2(d), t("afterLeave"));
  });
  onMounted(() => {
    let $ = c(d);
    onUnmounted($);
    ...
    if (o.value === _e.Hidden && !!d) {
      ...
      X(a.value, { hidden: () => h2(d), visible: () => c(d) });
    }
  });
  ...
  function O($) {
    ...
    !x || !(x instanceof HTMLElement) || T || (p.value = true, l.value && t("beforeEnter"), l.value || t("beforeLeave"), $(l.value ? Ln(x, g, S, I, A, (_) => {
      ...
      p.value = false, _ === Er.Finished && (Jt(f) || (a.value = "hidden", h2(d), t("afterLeave")));
    })));
  }
  return onMounted(() => {
    watch([l], ($, T, x) => {
...
var ct = defineComponent({ inheritAttrs: false, props: { as: { type: [Object, String], default: "div" }, show: { type: [Boolean], default: null }, unmount: { type: [Boolean], default: true }, appear: { type: [Boolean], default: false }, enter: { type: [String], default: "" }, enterFrom: { type: [String], default: "" }, enterTo: { type: [String], default: "" }, entered: { type: [String], default: "" }, leave: { type: [String], default: "" }, leaveFrom: { type: [String], default: "" }, leaveTo: { type: [String], default: "" } }, emits: { beforeEnter: () => true, afterEnter: () => true, beforeLeave: () => true, afterLeave: () => true }, setup(e, { emit: t, attrs: r, slots: n }) {
  ...
  return onMounted(() => {
    ...
    let c = Mi(e, ["show", "appear", "unmount", "onBeforeEnter", "onBeforeLeave", "onAfterEnter", "onAfterLeave"]), h2 = { unmount: e.unmount };
    return z({ ourProps: { ...h2, as: "template" }, theirProps: {}, slot: {}, slots: { ...n, default: () => [h(Fu, { onBeforeEnter: () => t("beforeEnter"), onAfterEnter: () => t("afterEnter"), onBeforeLeave: () => t("beforeLeave"), onAfterLeave: () => t("afterLeave"), ...r, ...h2, ...c }, n.default)] }, attrs: {}, features: Zi, visible: a.value === "visible", name: "Transition" });
  };
} });
var Lu = {
  props: {
...
var st = "start";
var Ot = "end";
var oc = "clippingParents";
var os = "viewport";
var mt = "popper";
var lc = "reference";
var Rn = nr.reduce(function(e, t) {
  return e.concat([t + "-" + st, t + "-" + Ot]);
}, []);
var uc = [].concat(nr, [rr]).reduce(function(e, t) {
...
var gc = "write";
var yc = "afterWrite";
var _r = [cc, dc, fc, pc, hc, mc, vc, gc, yc];
function bc(e) {
...
var Oc = 'Popper: modifier "%s" requires "%s", but "%s" modifier is not available';
var Mn = ["name", "enabled", "phase", "fn", "effect", "requires", "options"];
function $c(e) {
...
var Nn = "Popper: Invalid reference or popper argument provided. They must be either a DOM element or virtual element.";
var Lc = "Popper: An infinite loop in the modifiers cycle has been detected! The cycle has been interrupted to prevent a browser crash.";
var Vn = {
  placement: "bottom",
  modifiers: [],
  strategy: "absolute"
...
function td(e, t) {
  ...
  m.length === 0 && (m = h2, console.error(["Popper: The `allowedAutoPlacements` option did not allow any", "placements. Ensure the `placement` option matches the variation", "of the allowed placements.", 'For example, "auto" cannot be used to allow "bottom-start".', 'Use "auto-start" instead.'].join(" ")));
...
var Id = 1;
var Ad = 2;
var Pd = "[object Boolean]";
var qd = "[object Date]";
var Cd = "[object Error]";
var Fd = "[object Map]";
var Ld = "[object Number]";
var kd = "[object RegExp]";
var Dd = "[object Set]";
var Bd = "[object String]";
var Rd = "[object Symbol]";
var Md = "[object ArrayBuffer]";
var jd = "[object DataView]";
var Gn = Ae ? Ae.prototype : void 0;
var vr = Gn ? Gn.valueOf : void 0;
...
var zd = Wd.propertyIsEnumerable;
var Xn = Object.getOwnPropertySymbols;
var Gd = Xn ? function(e) {
...
var Ff = {
  ...
  methods: {
    ...
    loadFilepondPlugins() {
      const e = [];
      return this.preview && (e.push(import("./filepond-plugin-image-exif-orientation.esm-WXWL7AWV.js")), e.push(import("./filepond-plugin-image-preview.esm-4SLBIFB5.js"))), this.accept.length > 0 && e.push(import("./filepond-plugin-file-validate-type.esm-K3YTZFYL.js")), (this.minFileSize || this.maxFileSize) && e.push(import("./filepond-plugin-file-validate-size.esm-LWJTUTHW.js")), (this.minImageWidth || this.maxImageWidth || this.minImageHeight || this.maxImageHeight || this.minImageResolution || this.maxImageResolution) && e.push(import("./filepond-plugin-image-validate-size.esm-OKBYG62L.js")), Promise.all(e);
    },
    initFilepond(e) {
      const t = this.inputElement.getAttribute("name"), r = this;
      return new Promise((n) => {
        import("./filepond.esm-OQKIHY5X.js").then((i) => {
  ...
  methods: {
    ...
    initChoices(e) {
      return new Promise((t) => {
        ...
        import("./choices-KTSC5RH4.js").then((i) => {
...
var hp = {
  ...
  watch: {
    modelValue() {
      !this.autosize || !this.autosizeInstance || import("./autosize.esm-DP6OUP6H.js").then((e) => {
        nextTick(() => e.default.update(this.element));
      });
    }
  },
  mounted() {
    this.element = this.$refs.textarea.querySelector("textarea"), this.autosize && import("./autosize.esm-DP6OUP6H.js").then((e) => {
...
var Fr = {
  ...
  init(e) {
    const t = this;
    import("./nprogress-EO6AFXHZ.js").then((r) => {
      let n = 0;
